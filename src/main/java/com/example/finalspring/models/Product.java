    package com.example.finalspring.models;
    ...
    @NotEmpty(message = "Информация о продавце не можеть быть пустым")
    ...
    //добавляет картинку к продукту
    public  void addImageToProduct(Image image){
        image.setProduct(this);
        imageList.add(image);
    }
    // При добавлении товара будет присваиватся дата
    @PrePersist
    private  void init(){
